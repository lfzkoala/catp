...
//! Proofs use the keccak256-based EvmTranscript so they can be shared between
//! the Rust verifier endpoint and WASM bindings. The historical Solidity
//! verifier generation path was removed after exceeding the EVM contract size
//! limit; use `authorization_groth16_v1` for compact on-chain verification.
//!
...
impl AuthorizationProofSystem {
    ...
    /// Load a proof system from a serialized SRS file.
