...
/// @notice Historical IVerifier wrapper around the auto-generated Halo2Verifier assembly contract.
...
///
///
///      IMPORTANT: this wrapper is retained for off-chain/reference Halo2 work
///      and compatibility tests. The generated Halo2Verifier for the current
///      circuit is not deployable on EVM because its corrected runtime bytecode
///      exceeds the EVM contract-size limit. Current EVM authorization
///      deployments use Groth16AuthorizationVerifier.
