...
| 2 | TypeScript SDK — `PolicyBuilder`, `AuthorizerClient`, `ProofClient` | ✅ Complete (25 tests) — sends proof + public inputs to verifier |
| 2 | E2E Rust test — policy → Poseidon → proof → off-chain verify | ✅ Complete (3 tests) |
| 3 | `CommitRegistry.sol` | ✅ Complete (10 tests) |
| 3 | `MPAVerifier.sol` | ✅ Complete (11 tests) |
| 3 | `OptimisticChallenge.sol` | ✅ Complete (8 tests) |
